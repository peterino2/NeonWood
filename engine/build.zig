...
pub fn createGameExecutable(
    ...
    exe.addCSourceFile("modules/graphics/lib/cimgui/imgui/imgui.cpp", cflags.items);
    exe.addCSourceFile("modules/graphics/lib/cimgui/imgui/imgui_demo.cpp", cflags.items);
